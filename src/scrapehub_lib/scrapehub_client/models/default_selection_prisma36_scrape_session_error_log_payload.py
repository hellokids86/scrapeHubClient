...
class DefaultSelectionPrisma36ScrapeSessionErrorLogPayload(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["context", "createdAt", "details", "stackTrace", "message", "severity", "errorType", "sessionId", "id"]
