...
class RecordErrorResponse(BaseModel):
    ...
    data: DefaultSelectionPrisma36ScrapeSessionErrorLogPayload
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": DefaultSelectionPrisma36ScrapeSessionErrorLogPayload.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
