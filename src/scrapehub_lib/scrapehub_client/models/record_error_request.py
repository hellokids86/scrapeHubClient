...
class RecordErrorRequest(BaseModel):
    ...
    RecordErrorRequest
    """ # noqa: E501
    error: PickScrapeSessionErrorLogExcludeKeyofScrapeSessionErrorLogIdOrCreatedAt
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": PickScrapeSessionErrorLogExcludeKeyofScrapeSessionErrorLogIdOrCreatedAt.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
