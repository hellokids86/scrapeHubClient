...
class UserSettingsResponseData(BaseModel):
    """
    UserSettingsResponseData
    """ # noqa: E501
    scraper_assignments: Optional[List[StrictStr]] = Field(default=None, alias="scraperAssignments")
    ...
    email: StrictStr
    username: StrictStr
    __properties: ClassVar[List[str]] = ["scraperAssignments", "roles", "settings", "fullname", "email", "username"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "scraperAssignments": obj.get("scraperAssignments"),
            "roles": obj.get("roles"),
